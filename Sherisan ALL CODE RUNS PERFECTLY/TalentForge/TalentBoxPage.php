...
$sql = "SELECT tblregusers.RUID, tblregusers.Name, tblregusers.Surname, tblregusers.ContactNum, tblregusers.Email, tblcvs.FileLocation FROM tblregusers LEFT JOIN tblcvs ON tblregusers.RUID = tblcvs.RUID";
